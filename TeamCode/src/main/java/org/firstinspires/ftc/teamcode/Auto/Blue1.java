...
public class Blue1 extends LinearOpMode {
    ...
    public static double SPIKE_MARK_X_LEFT = 32.5;
    public static double SPIKE_MARK_Y_LEFT = 33;
    public static double BACKDROP_X_LEFT = 45.5;
    public static double BACKDROP_Y_LEFT = 39;

    public static double SPIKE_MARK_X_MIDDLE = 25;
    public static double SPIKE_MARK_Y_MIDDLE = 23;
    public static double BACKDROP_X_MIDDLE = 45.5;
    public static double BACKDROP_Y_MIDDLE = 33.8;

    public static double SPIKE_MARK_X_RIGHT = 11;
    public static double SPIKE_MARK_Y_RIGHT = 33;
    public static double BACKDROP_X_RIGHT = 46;
    public static double BACKDROP_Y_RIGHT = 26;

    public static double SPIKE_MARK_ANGLE = 180;
    public static double BACKDROP_ANGLE = 180;

    public static double INIT_PARK_X = 45;
    public static double INIT_PARK_Y = 10;
    public static double PARK_X = 50;
    public static double PARK_Y = 10;
