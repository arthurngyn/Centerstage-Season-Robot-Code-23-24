...
public class Red2 extends LinearOpMode {
    ...
    public static double INIT_SPIKE_MARK_X_LEFT = -35;
    public static double INIT_SPIKE_MARK_Y_LEFT = -33;
    public static double SPIKE_MARK_X_LEFT = -36;
    public static double SPIKE_MARK_Y_LEFT = -32;
    public static double BACKDROP_X_LEFT = 48;
    public static double BACKDROP_Y_LEFT = -25;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double spike_mark_x, spike_mark_y, backdrop_x, backdrop_y, init_spike_mark_x, init_spike_mark_y, spike_mark_angle;
        ...
        switch (cube_position) {
            ...
            default:
                ...
                spike_mark_angle = SPIKE_MARK_ANGLE;
                break;
        }
        ...
        TrajectorySequence DRIVE_TRUSS = drive.trajectorySequenceBuilder(DROP_SPIKE.end())
                ...
                .lineToSplineHeading(new Pose2d(DRIVE_TRUSS_X, DRIVE_TRUSS_Y-1, Math.toRadians(SPIKE_MARK_ANGLE)))
