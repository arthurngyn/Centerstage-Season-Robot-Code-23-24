...
public class Red1 extends LinearOpMode {
    ...
    public static double INIT_SPIKE_MARK_X_RIGHT = 30;
    public static double INIT_SPIKE_MARK_Y_RIGHT = -31;
    public static double SPIKE_MARK_X_RIGHT = 33.5;
    //31.5
    public static double SPIKE_MARK_Y_RIGHT = -33;
    public static double BACKDROP_X_RIGHT = 52;
    public static double BACKDROP_Y_RIGHT = -40;

    public static double INIT_SPIKE_MARK_X_MIDDLE = 23;
    ...
    public static double BACKDROP_X_MIDDLE = 52;
    public static double BACKDROP_Y_MIDDLE = -34.5;

    public static double INIT_SPIKE_MARK_X_LEFT = 13;
    public static double INIT_SPIKE_MARK_Y_LEFT = -33;
    public static double SPIKE_MARK_X_LEFT = 11;
    public static double SPIKE_MARK_Y_LEFT = -33;
    public static double BACKDROP_X_LEFT = 52;
    public static double BACKDROP_Y_LEFT = -31.5 ;
