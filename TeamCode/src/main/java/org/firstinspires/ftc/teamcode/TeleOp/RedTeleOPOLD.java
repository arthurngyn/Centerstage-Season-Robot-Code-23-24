...
//import static org.firstinspires.ftc.teamcode.Hardware.Variables.IntakeArmVariables.MANUAL_DOWN;
//import static org.firstinspires.ftc.teamcode.Hardware.Variables.IntakeArmVariables.MANUAL_UP;
...
//public class RedTeleOPOLD extends LinearOpMode {
...
//                drivetrain.power(AnglePIDControl(Math.toRadians(180), robotTheta));
...
//                intakeArm.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
//                intakeArm.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
//                intakeArm.setPower(MANUAL_UP);
//            }
//            else if(gamepad1.dpad_down){
//                intakeArm.setPower(MANUAL_DOWN);
//            }else{
...
//            telemetry.addData("Intake Power", intakeArm.getPower());
