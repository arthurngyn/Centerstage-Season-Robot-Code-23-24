...
//    public static double SPIKE_MARK_Y_LEFT = -34;
//    public static double BACKDROP_X_LEFT = 51;
//    public static double BACKDROP_Y_LEFT = -29;
//
//    public static double SPIKE_MARK_X_MIDDLE = 24;
//    public static double SPIKE_MARK_Y_MIDDLE = -24;
//    public static double BACKDROP_X_MIDDLE = 51;
//    public static double BACKDROP_Y_MIDDLE = -33.8;
//
//    public static double SPIKE_MARK_X_RIGHT = 31.5;
//    public static double SPIKE_MARK_Y_RIGHT = -33;
//    public static double BACKDROP_X_RIGHT = 51;
//    public static double BACKDROP_Y_RIGHT = -45;
//
//    public static double SPIKE_MARK_ANGLE = 180;
//    public static double BACKDROP_ANGLE = 180;
//    public static double PARK_ANGLE = 180;
//
//    public static double INIT_PARK_X = 43;
//    public static double INIT_PARK_Y = -8;
//    public static double PARK_X = 47;
//    public static double PARK_Y = -8;
//
//
